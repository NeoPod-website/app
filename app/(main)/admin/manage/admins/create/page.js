...
import AdminUserMain from "@/components/layout/admins/manage/AdminUserMain";
...
const breadcrumbsList = [
  ...
  {
    title: "Create",
    href: "/admin/manage/admins/create",
  },
];

export const metadata = {
  title: "Create Admin | Super Admin Panel | NeoPod",
  description:
    "Create a new admin account to manage PODs and oversee community activities.",
};
  ...
  return (
    ...
    >
      {user.role_type === "super" ? (
        <AdminUserMain isNew={true} role={user.role_type} />
      ) : (
        <div className="mt-8 flex h-full flex-col items-center justify-center rounded-xl border border-red-500/40 bg-red-500/5 p-8">
          ...
          <p className="mb-6 text-center text-red-300">
            You do not have permission to create new admin accounts.
          </p>
