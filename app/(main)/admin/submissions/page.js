...
//       // If current is found and not the last item, return next
//       if (currentIndex !== -1 && currentIndex < submissions.length - 1) {
//         return submissions[currentIndex + 1];
//       }

//       // If it's the last item, return the previous one
//       if (currentIndex === submissions.length - 1 && currentIndex > 0) {
//         return submissions[currentIndex - 1];
//       }

//       // If only one item or not found, return null
//       return null;
//     },
//     [submissions],
//   );
...
//       if (wasJustReviewed && currentStatus === "pending") {
...
//       }
//     },
//     [selectedSubmission, currentStatus, getNextSubmission],
//   );
