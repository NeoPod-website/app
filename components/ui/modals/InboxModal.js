...
//       <div
//         className={`fixed -top-5 left-0 z-50 h-full w-full max-w-2xl bg-black/30 shadow-2xl backdrop-blur-xl transition-all duration-300 ease-out ${
//           isVisible ? "translate-x-0" : "-translate-x-full"
//         }`}
//       >
//         <div className="bg-gradient-black/50 absolute inset-0 backdrop-blur-sm" />
...
//             <div className="border-t border-gray-400/30 bg-gray-900/60 px-6 py-3 backdrop-blur-xl">
