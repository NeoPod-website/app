...
//           `${process.env.NEXT_PUBLIC_API_URL}/ambassadors/admin/role/${ambassador.ambassador_id}`,
//           {
//             method: "PATCH",
//             headers: {
...
//           `${process.env.NEXT_PUBLIC_API_URL}/ambassadors/admin/status/${ambassador.ambassador_id}`,
//           {
//             method: "PATCH",
//             headers: {
//               "Content-Type": "application/json",
...
//           throw new Error(statusError.message || "Failed to update status");
//         }
//       }
