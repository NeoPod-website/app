...
const SubmissionCardLoader = () => {
  return (
    <div className="flex flex-col rounded-2xl border border-gray-400 bg-gradient-dark p-4 shadow-lg shadow-black/20 3xl:p-6">
      ...
      <div className="mb-2 h-5 w-2/3 animate-pulse rounded-md bg-gray-600 3xl:mb-4" />

      <div className="mb-2 space-y-2 rounded-xl border-l-4 border-yellow-500/60 bg-white/10 p-4 3xl:mb-4">
