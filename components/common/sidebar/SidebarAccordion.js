    ...
    <Accordion selectionMode="single" className="p-0">
      <AccordionItem
        ...
        classNames={{
          ...
          title: `text-gray-100 hover:text-white md:hidden xl:inline text-sm 3xl:text-base ${isActive ? "!bg-gray-500 text-white hover:!border-white hover:!bg-transparent select-none" : ""}`,
        }}
      >
        {children.map((child, childIndex) => (
          <Link
            ...
            className="sidebar-menu-item ml-6 scale-100 select-none text-sm text-gray-200 transition-all active:scale-95 md:ml-0 xl:ml-6 2xl:ml-8 3xl:text-base"
          >
