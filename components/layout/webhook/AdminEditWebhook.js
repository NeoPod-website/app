...
const AdminEditWebhook = ({
  ...
  const handleFormSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/webhooks/${initialWebhookData.webhook_id}`,
          {
            method: "PUT",
    ...
    [webhookData, router, setIsSubmitting, initialWebhookData.webhook_id],
  );
...
export default AdminEditWebhook;
