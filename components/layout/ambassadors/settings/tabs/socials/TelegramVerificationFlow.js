...
//   Users,
// } from "lucide-react";
// import { Card, CardBody, Button, Chip, Input, Code } from "@heroui/react";
...
//     step: "generate", // 'generate', 'waiting', 'success', 'error'
//     code: null,
//     isLoading: false,
//     error: null,
//     expiresAt: null,
...
//     if (verificationState.step === "waiting" && verificationState.code) {
//       interval = setInterval(async () => {
//         try {
//           const response = await fetch(
//             `${process.env.NEXT_PUBLIC_API_URL}/telegram/verification-status?verificationCode=${verificationState.code}`,
//             {
...
//                 description:
//                   "Your Telegram account has been successfully verified.",
//                 color: "success",
//                 timeout: 4000,
//               });
...
//     };
//   }, [verificationState.step, verificationState.code, onSuccess, platformKey]);

//   // Update time remaining
//   useEffect(() => {
//     let interval;

//     if (verificationState.expiresAt) {
...
//     try {
//       const response = await fetch(
//         `${process.env.NEXT_PUBLIC_API_URL}/telegram/generate-verification`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           credentials: "include",
...
//                         <span>Account automatically connected!</span>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                       <p>• No message reading permissions</p>
...
//                           The bot will confirm your connection and redirect you
//                           back here
//                         </p>
//                       </div>
//                     </div>
...
//                 <p>• Ensure you can receive messages from bots</p>
...
//   Shield,
// } from "lucide-react";
// import { Card, CardBody, Button, Chip, Code } from "@heroui/react";
// import { addToast } from "@heroui/react";
...
//   // Enhanced polling with better success detection
//   useEffect(() => {
//     let interval;
...
//                 step: "error",
//                 error:
//                   "Verification code is invalid or has been used. Please generate a new one.",
//               }));
//               clearInterval(interval);
//             }
//           } else {
//             // If we get an error response, increment poll attempts
//             setVerificationState((prev) => ({
//               ...prev,
//               pollAttempts: prev.pollAttempts + 1,
//             }));

//             // If too many failed attempts, show error
//             if (verificationState.pollAttempts > 15) {
//               setVerificationState((prev) => ({
//                 ...prev,
//                 step: "error",
...
//           // Show error after too many failures
//           if (verificationState.pollAttempts > 15) {
//             setVerificationState((prev) => ({
//               ...prev,
//               step: "error",
...
//     verificationState.code,
//     verificationState.pollAttempts,
//     onSuccess,
//     platformKey,
//   ]);
...
//       isLoading: true,
//       error: null,
//       pollAttempts: 0, // Reset poll attempts
//     }));
...
//                         </p>
//                         <p className="mt-1 text-xs text-gray-400">
//                           The bot will show "⏳ Verifying..." then confirm your
//                           connection
//                         </p>
//                       </div>
//                     </div>
...
//                     </p>
//                     <p className="text-xs text-gray-400">
//                       Checking status automatically every 2 seconds (attempt{" "}
//                       {verificationState.pollAttempts + 1})
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                 <p>• The verification code expires in 10 minutes</p>
//                 <p>
//                   • Wait for the bot to show "⏳ Verifying..." before sending
//                   another code
//                 </p>
//                 <p>
