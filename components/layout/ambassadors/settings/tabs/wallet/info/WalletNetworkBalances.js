...
//     try {
//       return getNetworkConfig(selectedNetwork);
//     } catch {
//       return getNetworkConfig("neo");
//     }
//   };

//   const fetchNativeBalance = async (networkKey, walletAddress) => {
//     try {
//       const config = getNetworkConfig(networkKey);

//       // Use fetch instead of ethers for RPC calls
...
//   const fetchTokenPrice = async (networkKey) => {
//     try {
//       const config = getNetworkConfig(networkKey);
...
//   const loadBalanceForNetwork = async (networkKey) => {
//     if (!address) return;
...
//       // Load balances for all networks in parallel
//       await Promise.all(
...
//   const currentNetworkBalance = networkBalances[selectedNetwork] || {
//     balance: "0",
//     error: null,
//     balanceUSD: "0",
//     isLoading: false,
...
//                       color="danger"
//                       className="mt-3"
//                       onPress={() => loadBalanceForNetwork(selectedNetwork)}
//                     >
//                       Try Again
//                     </Button>
//                   </div>
...
// export default WalletNetworkBalances;
