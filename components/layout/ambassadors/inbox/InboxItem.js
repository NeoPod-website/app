  ...
  return (
    <div
      className={`mt-4 overflow-hidden transition-all duration-300 ${
        isExpanded
          ? "thin-scrollbar max-h-96 overflow-y-scroll pr-3 opacity-100"
          : "max-h-0 opacity-0"
      }`}
    >
      <div className="border-t border-gray-600/30 pt-4">
        <div className="mb-3 flex items-center gap-2">
          <HistoryIcon className="h-4 w-4 text-gray-300" />
                ...
                <div className="flex-1 pb-3">
                  ...
                  {entry.pod_points_awarded > 0 && (
                    <div className="mt-2 flex items-center gap-1">
                      <span className="text-xs text-gray-300">Awarded:</span>
  ...
  ({
    ...
    return (
      <div
        ...
        style={{
          animationName: isVisible ? "slideInLeft" : "none",
      ...
      >
        ...
        <div className="relative flex items-start gap-4">
          <div
            className={`hidden h-10 w-10 items-center justify-center rounded-full text-sm font-bold text-white shadow-md transition-all duration-200 sm:flex ${
              isUnread
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <span className="text-sm font-bold capitalize text-white transition-all duration-200">
