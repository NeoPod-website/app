...
// // Enhanced status configuration for sidebar descriptions
...
//         "You may need to create a new submission if you want to attempt this quest again.",
...
//   return statusInfo[status?.toLowerCase()] || statusInfo.pending;
// };
