...
// const SubmissionsListHeader = ({ currentPod }) => {
//   return (
...
//           <span>{currentPod?.name || "Current Pod"}</span>
//         </div>
//       </div>

//       <FilterIcon className="h-5 w-5 text-foreground-400" />
//     </div>
//   );
// };
...
// const SubmissionsListHeader = ({ currentPod, totalCount, currentStatus }) => {
...
// const SubmissionsListHeader = ({ currentPod, loadedCount, currentStatus }) => {
//   const getStatusLabel = (status) => {
//     const statusLabels = {
//       all: "All",
//       pending: "Pending",
