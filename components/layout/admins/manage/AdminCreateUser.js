...
//             description="Must be unique and contain only letters, numbers, underscores, and hyphens"
//             classNames={{
//               inputWrapper:
...
//             errorMessage={errors.roleType}
//             placeholder="Select admin role"
//             selectedKeys={adminData.roleType ? [adminData.roleType] : []}
//             startContent={<Shield size={18} className="text-gray-400" />}
//             onValueChange={(value) => handleAdminDataChange("role_type", value)}
