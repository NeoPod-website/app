...
// const QuestTelegramTask = ({ task, telegramUser }) => {
...
// const QuestTelegramTask = ({ task, telegramUser = "hi" }) => {
//   const [loading, setLoading] = useState(false);
//   const [groupData, setGroupData] = useState(null); // Changed from channelData to groupData
...
//         description: `Successfully verified in ${groupData?.title}`,
//         color: "success",
//       });

//       // Mark quest as completed
//        markQuestAsSubmitted(task.id);
//     } catch (err) {
...
//           <p className="text-sm text-gray-100">
//             {joinVerified
//               ? `✅ Verified in ${groupData?.title || task?.channelName || task?.groupName}`
...
const QuestTelegramTask = ({ task, questId, telegramUser = "hi" }) => {
