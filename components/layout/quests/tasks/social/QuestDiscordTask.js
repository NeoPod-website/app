...
// import { ShieldAlertIcon, Users, Hash, Crown } from "lucide-react";

// import { markQuestAsSubmitted } from "@/redux/slice/submissionSlice";

// const QuestDiscordTask = ({ task, discordUser }) => {
...
//       // Discord API endpoint to get invite information
...
//       console.log(
//         "Verifying Discord join for:",
//         serverData?.name || task?.serverName,
//       );
//       console.log("Task ID:", task?.id);

//       // Call backend to verify Discord membership & assign role
//       const response = await fetch(
...
//       // Optionally mark the task/quest as complete
//       await markQuestAsSubmitted(task.id);
//     } catch (err) {
...
//         {error && (
//           <div className="flex items-center gap-2 rounded-xl border border-red-300 bg-red-900/20 px-3 py-2">
...
//         {joinVerified && (
//           <div className="flex items-center gap-2 rounded-xl border border-green-300 bg-green-900/20 px-3 py-2">
//             <ShieldAlertIcon className="h-4 w-4 text-green-400" />

//             <p className="text-sm text-green-300">
//               ✅ Successfully verified! Quest completed.
//             </p>
//           </div>
//         )}
...
//             Join {serverData?.name || "our Discord server"} to complete this
//             quest.
//           </p>
//         </div>
...
// const QuestDiscordTask = ({ task, discordUser = "hi" }) => {
...
//         description: `Successfully verified in ${serverData?.name || task?.serverName}`,
//         color: "success",
//       });

//       dispatch(markQuestAsSubmitted(task.id));
//     } catch (err) {
...
//           <p className="text-sm text-gray-100">
//             {joinVerified
//               ? `✅ Verified in ${serverData?.name || task?.serverName}`
...
const QuestDiscordTask = ({ task, questId, discordUser = "hi" }) => {
  const dispatch = useDispatch();
