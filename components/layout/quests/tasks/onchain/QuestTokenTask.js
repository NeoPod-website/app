...
//   // Memoized native token details getter
//   const getNativeTokenDetails = useCallback((network) => {
//     return NATIVE_TOKEN_CONFIGS[network] || NATIVE_TOKEN_CONFIGS.ethereum;
//   }, []);
